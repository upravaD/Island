...
public class Boa extends Predator {
    ...
    public void eat(List<Object> list) { //Параметры: список ячейки массива island
        ...
        if (list.contains(Fox.fox.getIcon()) && Main.random.nextInt(101) < 15) { // Если list содержит обьект Herbivores то с определленой вероятностью
            ...
            setFoodSaturation(getFoodSaturation() + Fox.fox.getWeight()); // Увеличиваем значение насыщения foodSaturation
    ...
    public void multiply() {
        ...
        CellPosition.changeCell(Main.factory.createAnimal(AnimalType.BOA.ordinal()).getIcon(), getCurrentPosition()); // Создаем boa через AnimalFactory
