...
public class Wolf extends Predator {
    ...
    public void eat(List<Object> list) { //Параметры: список ячейки массива island
        ...
        if (list.contains(Horse.horse.getIcon()) && Main.random.nextInt(101) < 10) { // Если list содержит обьект Herbivores то с определленой вероятностью
            ...
            super.setFoodSaturation(getMaxFoodSaturation()); // Увеличиваем значение насыщения foodSaturation
    ...
    public void multiply() {
        ...
        CellPosition.changeCell(Main.factory.createAnimal(AnimalType.WOLF.ordinal()).getIcon(), this.getCurrentPosition()); // Создаем wolf через AnimalFactory
