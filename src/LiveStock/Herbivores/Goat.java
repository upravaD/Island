...
public class Goat extends Herbivores {
    ...
    public void multiply() {
        ...
        CellPosition.changeCell(Main.factory.createAnimal(AnimalType.GOAT.ordinal()).getIcon(), getCurrentPosition()); // Создаем goat через AnimalFactory
        StatisticData.herbivoresBornCount++; // Статистика
        System.out.println(getClass().getSimpleName() + " multiply");
    }
